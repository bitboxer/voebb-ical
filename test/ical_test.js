...
import ical from '../src/app/ical.mjs';
...
describe('iCal', () => {
  it('should return an ical for two books', () => {
    const ics = cleanupIcal(fs
      .readFileSync('./test/data/loans.ics')
      .toString()
      .trim());
    ...
    const books = [
      {
        book:
          'Geisel : [Comic] / Guy Delisle ; [aus dem Französischem von Heike Drescher ; Textbearbeitung: Ulrich Pröfrock]\nComic Deli\n03825165458',
        date: new Date(Date.UTC(2018, 2, 3)),
        location: 'Friedrichshain - Kreuzberg: Bibliothek Frankfurter Allee 14a',
      },
      {
        book:
          'Aufzeichnungen aus Birma : [Comic] / Guy Delisle. [Aus dem Franz. von Kai Wilksen]\nComic Deli\n02184346458',
        date: new Date(Date.UTC(2018, 2, 3)),
        location: 'Friedrichshain - Kreuzberg: Bibliothek Frankfurter Allee 14a',
      },
    ];
